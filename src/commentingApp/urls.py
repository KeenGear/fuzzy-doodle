...
from .views import PostCreateView, PostListView, PostDeleteView, UserPostListsView, PostDetailView, PostUpdateView, FollowersListView, FollowsListView, post_list
from . import views
